...
class Buyer2 {
	...
	public void buy(Product2 product) {
		...
		System.out.println(" 구입 물품은 "  + product.toString());
	...
	public void summary()  {
		...
		System.out.println(" 총 구입 목록은 " + totalList);
		System.out.println("총 구입 가격은 " + totalprice);
		System.out.println("총 누적 포인트 는 " + totalbonuspoint);
	}
